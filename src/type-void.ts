...
function unaFuncion(user: any): any { //el tipo de dato any
    console.log('User Info', user.id, user.username, user.firstName);
    // return 'Hola';
}

unaFuncion({ id: 1, username: 'digcakes', firstName: 'Digneli'});
...
showFormattedInfo({id: 1, username: 'digcakes', firstName: 'Digneli'});
